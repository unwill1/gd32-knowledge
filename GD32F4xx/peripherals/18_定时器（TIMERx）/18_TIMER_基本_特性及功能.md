...
图 18-64. 内部时钟分频为 1 时，计数器的时序图


![image](images/696be8a7912e.jpg)
...
图 18-65. 当 PSC 数值从 0 变到 2 时，计数器的时序图


![image](images/b51fdcd46f52.jpg)
...
图 18-66. 向上计数时序图，PSC=0/2


![image](images/f0e545b8b118.jpg)



图 18-67. 向上计数时序图，在运行时改变 TIMERx_CAR 寄存器的值


![image](images/467e1d52e18f.jpg)
