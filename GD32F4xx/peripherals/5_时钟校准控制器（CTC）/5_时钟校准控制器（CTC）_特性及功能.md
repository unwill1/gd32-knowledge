...
CTC 模块的内部结构图如图 5-1. CTC 简介。


图5-1. CTC简介


![image](images/0963d4a2a7de.jpg)
...
$$
\text { RLVALUE } = \left(\text { F\_clock } \div \text { F\_REF }\right) - 1 \tag {式5-1}
$$
