...
<table><tr><td>位/位域</td><td>名称</td><td>说明</td></tr><tr><td>31:4</td><td>保留</td><td>必须保持复位值。</td></tr><tr><td>3:0</td><td>PSC[3:0]</td><td>独立看门狗定时器计时预分频选择。写这些位之前要通过向FWDGT_CTL寄存器写0x5555去除写保护。在改写这个寄存器的过程中,FWDGT_STAT寄存器的PUD位被置1,此时读取此寄存器的值都是无效的。0000: 1 / 40001: 1 / 80010: 1 / 16</td></tr></table>
