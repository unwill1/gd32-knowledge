...
<table><tr><td>引脚</td><td>类型</td><td>描述</td></tr><tr><td>RX</td><td>输入</td><td>接收数据</td></tr><tr><td>TXCK</td><td>输出I/O(单线模式 / 智能卡模式)输出</td><td>发送数据。当USART使能后,若无数据发送,默认为高电平用于同步通信的串行时钟信号</td></tr><tr><td>nCTS</td><td>输入</td><td>硬件流控模式发送使能信号</td></tr><tr><td>nRTS</td><td>输出</td><td>硬件流控模式发送请求信号</td></tr></table>


图 20-1. USART 模块内部框图


![image](https://cdn-mineru.openxlab.org.cn/result/2026-07-24/b4ebc877-242d-4e50-8072-e3ef8caf304f/abb96dc2948b981e125423880d3902207509f8396e0d73532fb2467c65a37f60.jpg)
...
图20-2. USART字符帧（8数据位和1停止位）


![image](https://cdn-mineru.openxlab.org.cn/result/2026-07-24/b4ebc877-242d-4e50-8072-e3ef8caf304f/77cb84e5fffabec4f1868ffa9ce82f6fa5009aac94739a865af659ef80b0f071.jpg)
...
![image](https://cdn-mineru.openxlab.org.cn/result/2026-07-24/b4ebc877-242d-4e50-8072-e3ef8caf304f/d43c1739ef3c126ba6e1fe7ab92a11e7374acc3ac5b6517e4f98802e396c8041.jpg)
...
![image](https://cdn-mineru.openxlab.org.cn/result/2026-07-24/b4ebc877-242d-4e50-8072-e3ef8caf304f/a6735c41b931a36ee9d751bc749a04baadaa8838ea0eaeff8bf2abcbaa7c3fee.jpg)
...
当接收到一帧数据，而RBNE位还没有被清零，随后的数据帧将不会存储在数据接收缓冲区中。USART_STAT寄存器中的溢出错误标志位ORERR将置位。如果使能DMA并置位
...
当 DMA 用于 USART 发送时，DMA 将数据从片内 SRAM 传送到 USART 的数据缓冲区。配置步骤如 20-5. DMA USART 所示。


图 20-5. 采用 DMA 方式实现 USART 数据发送配置步骤


![image](https://cdn-mineru.openxlab.org.cn/result/2026-07-24/b4ebc877-242d-4e50-8072-e3ef8caf304f/0ae4bb4ea0b446d1f7bee0cf763b9b404a76c622251cb44275f0f0f9b98e839d.jpg)


所有数据帧都传输完成后，USART_STAT寄存器中TC位置1。如果USART_CTL0寄存器中TCIE置位，将产生中断。

当 DMA用于USART 接收时，DMA 将数据从接收缓冲区传送到片内 SRAM。配置步骤如20-6. DMA USART 所示。如果将 USART_CTL2 寄存器中 ERRIE 位置 1，USART_STAT 寄存器中的错误标志位（FERR、ORERR 和 NERR）置位时将产生中断。


图 20-6. 采用 DMA 方式实现 USART 数据接收配置步骤


![image](https://cdn-mineru.openxlab.org.cn/result/2026-07-24/b4ebc877-242d-4e50-8072-e3ef8caf304f/7dfebfc0f00044dc149a16239e9c04a4bfcaf6658e3703286a22909987e6c776.jpg)
...
![image](https://cdn-mineru.openxlab.org.cn/result/2026-07-24/b4ebc877-242d-4e50-8072-e3ef8caf304f/0ff4387e188524c3c80ad86e8671728fe2007634ca2d5f6507f75c84b832d0da.jpg)
...
![image](https://cdn-mineru.openxlab.org.cn/result/2026-07-24/b4ebc877-242d-4e50-8072-e3ef8caf304f/f61db7e6dadd601a0d10a9fbd131286b955c1295ca6f7da7d53f7268b6975483.jpg)
...
![image](https://cdn-mineru.openxlab.org.cn/result/2026-07-24/b4ebc877-242d-4e50-8072-e3ef8caf304f/385cc0a73517e7e5f3e00285bddc49956aaa9764877c56d1ad8038fd9f2324d6.jpg)
...
![image](https://cdn-mineru.openxlab.org.cn/result/2026-07-24/b4ebc877-242d-4e50-8072-e3ef8caf304f/fa69dbcd4a4d0cde550cca5ee6dd367fbb45ad38f087bab74b0bb547487bb6b1.jpg)
...
![image](https://cdn-mineru.openxlab.org.cn/result/2026-07-24/b4ebc877-242d-4e50-8072-e3ef8caf304f/da2a249dc50c46500da2af6992a3424ddce569a91de6ca5c7d49eb7ab1fe9f65.jpg)
...
![image](https://cdn-mineru.openxlab.org.cn/result/2026-07-24/b4ebc877-242d-4e50-8072-e3ef8caf304f/8151fa28fcd3c84fe5cc3cb1e1e5bbbfefa53fc15257ec8f3d3f7cf1709370b1.jpg)


## 20.3.10. 串行红外（IrDA SIR）编解码功能模块
...
![image](https://cdn-mineru.openxlab.org.cn/result/2026-07-24/b4ebc877-242d-4e50-8072-e3ef8caf304f/5b156529dab2f9d92902332b823fab204bff6b986aa20c978284ff974896fec1.jpg)
...
![image](https://cdn-mineru.openxlab.org.cn/result/2026-07-24/b4ebc877-242d-4e50-8072-e3ef8caf304f/f57ae92a273460fb26d38de5c58f2ecc624b8ff9add7d0f7788eefba1f10bf88.jpg)


将USART_CTL2寄存器中IRLP置位可以使SIR子模块工作在低功耗模式下。发送编码器由PCLK分频得到的低速时钟来驱动。分频系数在USART_GP寄存器中PSC[7:0]位配置，USART_BAUD寄存器配置为16*PSC[7:0]。TX引脚脉冲宽度可以为低功耗波特率的3倍。接收解码器工作模式与正常IrDA模式相同。
...
![image](https://cdn-mineru.openxlab.org.cn/result/2026-07-24/b4ebc877-242d-4e50-8072-e3ef8caf304f/6ec9360eb41bf927fce4a205b9d842c4d24bbc063e9a1d35c554e4aad2a1ea12.jpg)
...
在USART发送期间，如果检测到有奇偶校验错误，TX引脚在停止位最后一个位时间内被拉低，智能卡发送一个 信号。根据协议， 会自动重发 次。在重发数据帧前面会插入2位的帧间隔。最后一次重发字节后，TC会立即被置位。如果在最大重发次数后仍然收到NACK信号，USART将会停止发送，帧错误标志被置位。USART不会将NACK信号作为起始位。
...
图 20-16. USART 接收 FIFO 结构


![image](https://cdn-mineru.openxlab.org.cn/result/2026-07-24/b4ebc877-242d-4e50-8072-e3ef8caf304f/d29b04266eb0d90fe8f953d9da3cfb2f203a586ed7bf5304c6fcbe10fa4fd3f7.jpg)


如果软件在响应RBNE中断时读数据接收缓冲区，在响应开始时，RBNEIE位应清0。当所有接收的数据被读出后，RBNEIE位应置位。在读出接收的数据前，PERR，NERR，FERR，EBF都应被清0。

## 20.3.15. 从 Deepsleep 模式唤醒

通过标准RBNE中断或WUM中断USART能从深度睡眠模式唤醒MCU。

UESM位必须置1并且USART时钟必须设置为IRC16M或LXTAL（请参考 2RCU_CFG2））。
...
图 20-17. USART 中断映射框图


![image](https://cdn-mineru.openxlab.org.cn/result/2026-07-24/b4ebc877-242d-4e50-8072-e3ef8caf304f/7f4ce560f7a21b345ef98c86ab4c6e689ee30f1eb9706229d8661869e7e5b20b.jpg)
