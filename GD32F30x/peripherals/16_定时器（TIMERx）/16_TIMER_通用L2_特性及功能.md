...
16-57. L2 提供了通用定时器 L2 的内部配置细节



图 16-57. 通用定时器 L2结构框图


![image](images/a04adc23d29d.jpg)
...
16-60. PSC=0/2 和 16-61.TIMERx_CAR 给出了一些例子，当 TIMERx_CAR=0x99 时，计数器在不同预分频
...
16-63. 显示了三种比较输出模式：反转/置高电平/置低电平，
...
PWM 模式 0 和 PWM 模式 1 是 OxCPRE 的另一种输出类型，设置 CHxCOMCTL 位域位 0x06或0x07可以配置 PWM模式0/PWM模式1。在这些模式中，根据计数器值和TIMERx_CHxCV寄存器值的关系以及计数方向，OxCPRE 信号改变其电平。具体细节描述，请参考相应的位。
